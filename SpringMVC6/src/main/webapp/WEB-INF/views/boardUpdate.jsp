...
<body>
  ...
  <div class="panel panel-primary">
    ...
    <% Board vo = (Board) request.getAttribute("vo"); %>
    	<%--
    		게시글 수정기능을 작성하시오
    		BoardController에 Post방식의 요청을 받는 boardUpdate.do를 만든 다음
    		idx와 일치하는 게시글 정보(제목, 내용, 작성자)를 수정하시오.
    		수정 후 해당 쉉된 화면을 보는 상세보기 페이지로 이동합니다.
    	...
    	<table class="table table-bordered table-hover">
    		...
    		<tr>
    			<td>내용</td>
    			<td><textarea name="contents" rows="7" class="form-control" cols="" placeholder="내용을 이력하세요"><%=vo.getContents() %></textarea></td>
    		</tr>
    		<tr>
    			<td>작성자</td>
